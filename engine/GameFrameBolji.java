 ...
 *
 */
public abstract class GameFrameBolji extends JPanel implements MouseListener,
        MouseWheelListener, MouseMotionListener, KeyListener
{
     ...
     */
    public GameFrameBolji(String title, int sizeX, int sizeY)
    {
        super(true);
     ...
     * konstruktora, nakon što se svi resursi u?itaju i pripreme.
     */
    ...
    /**
     * Postavlja hint za viši kvalitet iscrtavanja koji ?e se onda automatski primjenjivati
     * nad Graphics2D objektom koji se daje u render() metodi
     * @param hq true za viši kvalitet interpolacije i uklju?en anti-aliasing primitiva
     */
     ...
     * sleep metodama, zbog ?ega je mogu? neravnomijeran tok izvršavanja (judder). Ukoliko
    ...
    /**
     * Metod ?e biti pozvan prilikom initGameWindow() poziva, nakon što je prozor konstruisan.
     */
     ...
     * zadatom frekvencijom (update rate). Ne treba da sadrži nikakva logi?ka ažuriranja, samo crtanje.
    ...
    /**
     * Metod koji ?e biti pozvan na pritisak tastera miša (okretanja scroll to?ka se tako?e smatraju tasterima)
    ...
    /**
     * Metod koji ?e biti pozvan na puštanje tastera miša (okretanja scroll to?ka se tako?e smatraju tasterima)
